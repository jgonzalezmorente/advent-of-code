...
\subsection{Parte II}
El objetivo de esta parte es el mismo que en la parte anterior, pero suponiendo que solo hay una carrera. Esta carrera se forma concatenando las cifras del tiempo empleado y distancia recorrida respectivamente. En el ejemplo anterior teníamos 
\begin{table}[h]
    \centering
    \begin{tabular}{|l|c|c|c|}
    \hline
...
Ahora solo tendremos que considerar esta carrera,
